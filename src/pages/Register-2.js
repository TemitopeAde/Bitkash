            ...
            <form>
              <Box className="register-form-grid">
                <Box className="register-grid">
                  ...
                  <div style={{gridTemplateColumns: '1fr'}} className="register-row">
                    <div className="register-name">
                  ...
                  <div style={{gridTemplateColumns: '1fr'}} className="register-row">
                    <Stack alignItems="center" justifyContent="flex-start" direction="row" spacing={2}>
                      <input style={{transform: 'scale(1.4)'}} type="checkbox" id="register-2-check" />
                      <label htmlFor="register-2-check">I have read and accepted the <Link style={{textDecoration: 'none', color: 'rgba(255, 153, 36, 1)'}} to="/">Terms & conditions</Link> </label>
                    </Stack>
                  </div>
                  <div
                  ...
                  >
                    <button className="register-previous" onClick={() => setform(2)} type="button">
                      Previous
                    </button>
